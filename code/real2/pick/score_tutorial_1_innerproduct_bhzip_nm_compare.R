...
source(file.path("R", "BHZIP_EB_250911.R"))
...
raw_data_dir <- file.path( "examples", "data", "oocyte_zygote_mm10", "1M")
anchor_file <- file.path("examples", "data", "mm10.genome_split_1M")
ref_file <- file.path("examples", "data", "oocyte_zygote_ref")
...
stan_file <- Sys.getenv("HICBZIP_NM_STAN_FILE", unset = "/home/xchen/schic/Functions/BHZIP_match_normal_251108.stan")
...
warning_log_file <- file.path(getwd(), "warnings_nm.log")
warning_snapshot_file <- file.path(getwd(), "warnings_last50_snapshot.log")
