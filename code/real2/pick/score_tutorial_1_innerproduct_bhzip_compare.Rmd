...
out_root <- file.path("data", "bhzip_score_compare_from_pairs")
...
raw_json <- file.path("results", "oocyte_zygote_raw_pairs", "1M", "innerproduct", "innerproduct.json")
bhzip_json <- file.path("results", "oocyte_zygote_bhzip_pairs", "1M", "innerproduct", "innerproduct.json")
