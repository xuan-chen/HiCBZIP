# score_innerproduct_schicimpute_10runs_varyseed.R
# Run with: Rscript score_innerproduct_schicimpute_10runs_varyseed.R
...
out_root <- file.path("results", "oocyte_zygote_schicimpute_10runs_innerproduct")
...
for (i in seq_len(n_runs)) {
  ...
  if (force_rerun || !file.exists(metrics_json)) {
    ...
    run_score_cmd(score_bin, args, label = paste("score embed schicimpute run", i))
  } else {
