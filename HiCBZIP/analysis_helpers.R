...
# Analysis helper functions used by HiCBZIP manuscript workflows.
#
# Common dependencies used by these helpers:
# library(dplyr)
# library(magrittr)
# library(ggplot2)
# library(tidyr)
...
# library(hicrep)
#
# Some specialized helpers require TopDom to be installed.
