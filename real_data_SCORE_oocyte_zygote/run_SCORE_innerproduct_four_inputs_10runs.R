...
inputs <- tibble::tribble(
  ...
  "raw",          "Raw",              path_here("data", "processed", "SCORE_oocyte_zygote", "score_ready_inputs", "HiCBZIP_GB_NB", "oocyte_zygote_raw_1M.scool"),        path_here("data", "processed", "SCORE_oocyte_zygote", "score_ready_inputs", "HiCBZIP_GB_NB", "oocyte_zygote_ref_min_depth_5000.tsv"),        path_here("results", "SCORE_oocyte_zygote", "server_json_runs"),                              "oocyte_zygote_raw_pairs_r%02d",
  "bhzip",        "HiCBZIP-GB(NB)",   path_here("data", "processed", "SCORE_oocyte_zygote", "score_ready_inputs", "HiCBZIP_GB_NB", "oocyte_zygote_bhzip_1M.scool"),      path_here("data", "processed", "SCORE_oocyte_zygote", "score_ready_inputs", "HiCBZIP_GB_NB", "oocyte_zygote_ref_min_depth_5000.tsv"),        path_here("results", "SCORE_oocyte_zygote", "server_json_runs"),                              "oocyte_zygote_bhzip_pairs_r%02d",
  "bhzip_nm",     "HiCBZIP-N(M)",     path_here("data", "processed", "SCORE_oocyte_zygote", "score_ready_inputs", "HiCBZIP_NM", "oocyte_zygote_bhzip_nm_1M.scool"),      path_here("data", "processed", "SCORE_oocyte_zygote", "score_ready_inputs", "HiCBZIP_NM", "oocyte_zygote_ref_min_depth_5000.tsv"),           path_here("results", "SCORE_oocyte_zygote", "server_json_runs_nm"),                           "oocyte_zygote_bhzip_nm_pairs_r%02d",
  "schicimpute",  "scHiCImpute",      path_here("data", "processed", "SCORE_oocyte_zygote", "score_ready_inputs", "scHiCImpute", "oocyte_zygote_schicimpute_1M.scool"), path_here("data", "processed", "SCORE_oocyte_zygote", "score_ready_inputs", "scHiCImpute", "oocyte_zygote_ref_min_depth_5000.tsv"),          path_here("results", "SCORE_oocyte_zygote", "oocyte_zygote_schicimpute_10runs_innerproduct"), "oocyte_zygote_schicimpute_pairs_r%02d"
)
