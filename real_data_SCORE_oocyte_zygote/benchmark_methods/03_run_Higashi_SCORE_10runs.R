# Run SCORE Higashi for the oocyte-to-zygote benchmark.
...
resolution <- "1M"
min_depth <- "5000"
higashi_epochs <- as.integer(Sys.getenv("HICBZIP_HIGASHI_EPOCHS", unset = "60"))

embedding_alg <- "higashi"
embedding_dir <- "higashi"
embedding_json <- "higashi.json"
out_root <- path_here("results", "SCORE_oocyte_zygote", "oocyte_zygote_higashi_10runs")
